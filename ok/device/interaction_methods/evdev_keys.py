...
# Fallback keycode mapping for when python-evdev is not installed
EVDEV_KEYCODE_FALLBACK = {
    'KEY_ESC': 1,
    'KEY_1': 2,
    'KEY_2': 3,
    'KEY_3': 4,
...
def get_evdev_keycode(key):
    ...
    if key_lower in EVDEV_KEY_MAP:
        key_name = EVDEV_KEY_MAP[key_lower]
    else:
    ...
    if ecodes is not None:
        ...
        if key_name in EVDEV_KEYCODE_FALLBACK:
            return EVDEV_KEYCODE_FALLBACK[key_name]
    return None
